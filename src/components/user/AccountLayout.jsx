...
import { User, MapPin, Lock, LogOut, Package, Wallet } from "lucide-react";
        ...
        <aside className="account-sidebar">
          <div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive ? "account-menu active" : "account-menu"
              }
            >
              <User size={18} />
              Profile
        ...
        <div className="logout-overlay">
          <div className="logout-modal">
            ...
            <div className="logout-actions">
              ...
              <button className="modal-block-btn" onClick={handleLogout}>
                Logout
              </button>
            </div>
          </div>
