...
export const getAdminProductDetail = createAsyncThunk(
  "product/getAdminProductDetail",

  async (productId, { rejectWithValue }) => {
    try {
      return await getAdminProductDetailAPI(productId);
    } catch (err) {
      return rejectWithValue(
        err.response?.data || {
...
export const createVariant = createAsyncThunk(
  ...
  async ({ productId, data }, { rejectWithValue }) => {
    try {
      return await createVariantAPI(productId, data);
    } catch (err) {
      return rejectWithValue(
        err.response?.data || {
...
export const toggleProductStatus = createAsyncThunk(
  ...
  async (productId, { rejectWithValue }) => {
    try {
      return await toggleProductStatusAPI(productId);
    } catch (err) {
      return rejectWithValue(
        err.response?.data || {
...
export const updateVariant = createAsyncThunk(
  ...
  async ({ variantId, data }, { rejectWithValue }) => {
    try {
      return await updateVariantAPI(variantId, data);
    } catch (err) {
      return rejectWithValue(
        err.response?.data || {
...
export const toggleVariantStatus = createAsyncThunk(
  ...
  async (variantId, { rejectWithValue }) => {
    try {
      return await toggleVariantStatusAPI(variantId);
    } catch (err) {
      return rejectWithValue(
        err.response?.data || {
...
export const uploadVariantImage = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      return await uploadVariantImageAPI(data);
    } catch (err) {
      return rejectWithValue(
        err.response?.data || {
...
export const deleteVariantImage = createAsyncThunk(
  "product/deleteVariantImage",

  async (imageId, { rejectWithValue }) => {
    try {
      await deleteVariantImageAPI(imageId);
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productError =
            formatProductApiError(action.payload) || "Failed to fetch products";
        },
      );
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productError =
            formatProductApiError(action.payload) || "Failed to fetch product";
        },
      );
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productSuccess = "Product created successfully";
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productSuccess = "Product updated successfully";
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productSuccess = "Product deleted successfully";
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productError =
            formatProductApiError(action.payload) || "Failed to delete product";
        },
      );
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          if (
            ...
            state.productDetail.is_active = action.payload.is_active;
          }
        },
      )
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productError =
            formatProductApiError(action.payload) ||
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productSuccess = "Variant created successfully";
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productError =
            formatProductApiError(action.payload) || "Failed to create variant";
        },
      );
    ...
    builder
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productSuccess = "Variant updated successfully";

          state.productError = null;

          if (!state.productDetail) return;

          state.productDetail.variants = state.productDetail.variants.map(
            (variant) =>
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.productError =
            formatProductApiError(action.payload) || "Failed to update variant";
        },
      );
    ...
    builder.addCase(
      ...
      (state, action) => {
        ...
        const variant = state.productDetail.variants.find(
          (item) => item.id === action.payload[0]?.variant,
        );

        if (variant) {
          variant.images = [...variant.images, ...action.payload];
        }
      },
    );
    ...
    builder.addCase(
      ...
      (state, action) => {
        ...
        state.productDetail.variants.forEach((variant) => {
