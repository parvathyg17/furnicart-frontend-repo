            ...
            <div className="pd-user-acc-body">
              ...
              <div className="pd-user-spec-grid pd-user-pdp-spec-grid">
                ...
                <div>
                  ...
                  <p>
                    Dust regularly; spot-clean with a soft dry cloth. Avoid
                    harsh chemicals.
                  </p>
                </div>
              </div>
          ...
          shippingOpen && (
            ...
            <div className="pd-user-acc-body">
              ...
              <p className="pd-user-pdp-shipping-copy">
                ...
                delivery if the item is unused and in original packaging.
                Contact support for a return authorization.
              </p>
            </div>
          )
        }
