      ...
      <div className="pd-main-image-wrap pd-user-hero-image">
        {primaryImage ? (
          ...
          >
            ...
            <OfferBadge label={offerBadge?.label} />
            ...
            >
              <img src={primaryImage} alt={productName} draggable={false} />
            </div>
          ...
          <div className="pd-main-image-empty">
            ...
            <div className="artisan-card-ph pd-user-ph">No image</div>
          </div>
        )}
      </div>
        ...
        <div className="pd-thumbs pd-user-thumbs">
          {galleryImages.map((url, idx) => (
            <button
              ...
              type="button"
              className={
                idx === galleryIndex ? "pd-thumb is-selected" : "pd-thumb"
              }
              onClick={() => {
                onSelectThumb(idx);
              }}
