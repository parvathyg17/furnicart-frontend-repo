...
function splitReason(
  ...
  const restFromLines = parts.slice(
    1,
  ).join(
    " ",
  ).trim();

  const note = restFromLines ||
    (
...
export default function AdminReturns() {
  ...
  return (
    ...
    <div className="ar-artisan">
                        ...
                        <tr key={`${r.id}-detail`} className="ar-expand">
                          ...
                          <td colSpan={7}>
                            ...
                            <div>
                              ...
                              <p style={{ margin: "0.35rem 0 0.75rem", whiteSpace: "pre-wrap" }}>
                                {r.reason || "—"}
                              </p>
      ...
      <p className="ar-copyright">
        © FurniCart admin · returns
      </p>
    </div>
  );
}
