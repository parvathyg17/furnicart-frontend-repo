...
import { X, ImagePlus, ChevronDown, Check } from "lucide-react";
...
export default function CreateCategoryModal({ isOpen, onClose, onSuccess }) {
  ...
  const { categoryOptions, categoryCreateLoading } = useSelector(
      ...
      <div className="category-modal">
        <div className="category-modal-header">
          <div>
            ...
            <p>Define a new category for your furniture collection.</p>
          </div>
