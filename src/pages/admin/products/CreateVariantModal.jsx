...
import { X, Plus, ImagePlus, Upload, Trash2 } from "lucide-react";
...
export default function CreateVariantModal({ isOpen, onClose, productId }) {
  ...
  const validateClient = () => {
    ...
    if (formData.is_active) {
      if (!formData.color.trim()) {
        next.color = "Color / finish is required for an active variant.";
      }

      if (!formData.material.trim()) {
        next.material = "Material is required for an active variant.";
      }

      if (!formData.size.trim()) {
        next.size = "Size / dimensions are required for an active variant.";
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (isSubmitting || productLoading) {
      return;
    }
    ...
    try {
      ...
      if (createVariant.rejected.match(result)) {
      ...
      <div className="create-variant-modal">
        ...
        <div className="create-product-header">
          <div>
            ...
            <p>
              Configure a unique material or finish combination for this
              product.
            </p>
          </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          <div className="create-product-body">
            ...
            <VariantMediaUploader
              ...
              isEditMode={false}
              onSaveNewImages={handleUploadSelected}
              uploadLoading={productLoading || isSubmitting}
            />
          </div>
