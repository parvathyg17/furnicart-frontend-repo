...
const JOURNEY_STEPS = [
  {
    ...
    text:
      "We partner with certified forests and local mills to source timber with documented provenance. Every slab is chosen for grain character, structural integrity, and the story it will carry into your home.",
    image:
  ...
  },
  {
    ...
    text:
      "Our furnicarts shape each piece by hand — joinery, sanding, and finishing guided by decades of craft. No shortcuts, no mass-production templates. Only deliberate work that honors the material.",
    image:
  ...
  },
  {
    ...
    text:
      "Before any piece leaves our workshop, it passes a rigorous quality review — surface feel, structural balance, and finish depth. What arrives at your door is ready to become part of your legacy.",
    image:
    ...
    <div className="about-page">
      ...
      >
        ...
        <div className="about-philosophy-text">
          ...
          <p>
            ...
            still feel essential a decade from now? We design for calm interiors,
            honest materials, and the quiet confidence of craftsmanship you can
            see and feel.
          </p>
              ...
              (item) => (
                ...
                >
                  ...
                  <div className="about-journey-copy">
                    ...
                    <span className="about-journey-step">
                      {item.step}
                    </span>
      ...
      <section className="about-sustainability-wrap">
        ...
        <div className="about-sustainability">
          ...
          <div className="about-sustainability-copy">
            ...
            <h2>
              Sustainability is the Soul of Design
            </h2>
            ...
            <p>
              ...
              low-waste workshops, and repairable construction are non-negotiable
              parts of every collection.
            </p>
            ...
            <ul className="about-sustainability-features">
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    Certified materials and transparent supply chains.
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <p>
                    heirloom-grade joinery that rewards care over decades.
                  </p>
                </div>
              </li>
            </ul>
      ...
      <footer className="about-footer">
        ...
        <div className="about-footer-social">
          ...
          >
            <span className="about-pinterest-mark">
              P
            </span>
          </a>
