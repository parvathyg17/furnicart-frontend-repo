          ...
          <>
            ...
            <div className="referral-card">
              ...
              <p className="referral-lead">
                ...
                {" "}wallet credit when they complete their first paid order.
                They get {referral.referee_benefit} on their first order.
              </p>
              ...
              {referral.welcome_coupon && (
                <div className="referral-welcome">
                  ...
                  <p>
                    Use code{" "}
                    <code>
                      {referral.welcome_coupon.code}
                    </code>
                    {" "}at checkout
                    {referral.welcome_coupon.is_used
                      ? " (already used)"
                      : ""}
                  </p>
